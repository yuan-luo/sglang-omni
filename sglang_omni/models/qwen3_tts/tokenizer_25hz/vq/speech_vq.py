...
try:
    ...
    sox = None  # type: ignore[assignment]
import copy
import operator
...
from sglang_omni.models.qwen3_tts.tokenizer_25hz.vq.core_vq import (
    DistributedGroupResidualVectorQuantization,
)
from sglang_omni.models.qwen3_tts.tokenizer_25hz.vq.whisper_encoder import (
    Conv1d,
    ConvTranspose1d,
    WhisperEncoder,
)
