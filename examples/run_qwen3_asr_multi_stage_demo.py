...
async def main():
    ...
    parser.add_argument(
        "--dtype", type=str, default="fp16" if torch.cuda.is_available() else "fp32"
    )
    ...
    request = OmniRequest(inputs={"text": "Audio recognition", "audio": dummy_audio})
